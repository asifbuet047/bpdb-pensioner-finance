document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.pensioner-delete-buttons').forEach((row) => {
        row.addEventListener('click', (e) => {
            ...
            const span = document.getElementById('pensionerDeleteActionModalSpan');
            span.innerText = name;
            const deleteButton = document.getElementById('pensionerDeleteButton');
            ...
            let modalElement = document.getElementById('pensionerDeleteActionModal');
    ...
    document.querySelectorAll('.pensioner-update-buttons').forEach((row) => {
        row.addEventListener('click', (e) => {
            let name = e.currentTarget.getAttribute('data-name');
            let index = e.currentTarget.getAttribute('data-index');
            const span = document.getElementById('pensionerUpdateActionModalSpan');
            span.innerText = name;
            const updateButton = document.getElementById('pensionerUpdateButton');
            updateButton.addEventListener('click', async () => {
                window.location.href = `/pensioner/update/${index}`;
            });

            let modalElement = document.getElementById('pensionerUpdateActionModal');
            let modal = bootstrap.Modal.getInstance(modalElement);
            modal.hide();
        });
    });
    ...
    document.querySelectorAll('.officer-delete-buttons').forEach((row) => {
        row.addEventListener('click', (e) => {
            ...
            const span = document.getElementById('officerDeleteActionModalSpan');
            span.innerText = name;
            ...
            let modalElement = document.getElementById('officerDeleteActionModal');
            let modal = bootstrap.Modal.getInstance(modalElement);
            modal.hide();
        });
    });
    ...
    document.querySelectorAll('.officer-update-buttons').forEach((row) => {
        row.addEventListener('click', (e) => {
            let name = e.currentTarget.getAttribute('data-name');
            let index = e.currentTarget.getAttribute('data-db-id');
            const span = document.getElementById('officerUpdateActionModalSpan');
            span.innerText = name;
            ...
            let modalElement = document.getElementById('officerUpdateActionModal');
            let modal = bootstrap.Modal.getInstance(modalElement);
            modal.hide();
        });
    });
