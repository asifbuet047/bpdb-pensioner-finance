...
export default function DeleteButtonComponent({ pensionerId, pensionerName, buttonStatus }) {
    ...
    const handleDelete = async () => {
        try {
            ...
            setSnackbarMessage(error.response?.data?.message || 'Failed to delete pensioner');
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                Are you sure you want to delete this pensioner name is
