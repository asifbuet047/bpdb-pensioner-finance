...
export default function WorkflowButtonComponent({ pensionerId, pensionerName }) {
    ...
    useEffect(() => {
        ...
        const fetchWorkflow = async () => {
            try {
                const response = await axios.get(`/api/pensioner/workflow/${pensionerId}`, {
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">View approval workflow?</h5>
                                <button type="button" className="btn-close" onClick={closeModal} />
                            </div>

                            <div className="modal-body">
                                Are you sure you want to view <strong>{pensionerName}</strong>'s
                                approval workflow?
                            </div>
